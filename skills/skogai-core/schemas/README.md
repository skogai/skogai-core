...
| `skill.schema.json`       | Claude Code SKILL.md entrypoint                                        | `name`, `description` in frontmatter; `<objective>`, `<routes>` sections                  |
| `router.schema.json`      | routing file variant                                                   | `<objective>`, `<routes>` sections                                                         |
